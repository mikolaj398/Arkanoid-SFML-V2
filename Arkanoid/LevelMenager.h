...
public:
	...
	void LoadLevel(Ball &ball, Paddle &paddle, std::vector<Block> &blocks);
	void SetBlocks(int level[howMuchBlocks][howMuchBlocks], std::vector<Block>& blocks, unsigned int blX, unsigned int blY);
	//metoda typu pustego
